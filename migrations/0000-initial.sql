...
CREATE TABLE IF NOT EXISTS Audio (
    ...
    ConversationID INT REFERENCES Conversations(ConversationID) ON UPDATE CASCADE ON DELETE SET NULL
);

CREATE TABLE IF NOT EXISTS UsersConversations (
    UserID CHAR(20) REFERENCES Users(UserID) ON UPDATE CASCADE ON DELETE CASCADE,
    ConversationID INT REFERENCES Conversations(ConversationID) ON UPDATE CASCADE ON DELETE CASCADE
);
